/*
    -- MAGMA (version 2.0) --
       ...
       @author Mark Gates
       @generated from interface_cuda/blas_z_v2.cpp, normal z -> c, Sat Mar 27 20:31:15 2021
*/
    ...
    magma_queue_t queue )
{
    ...
    magmablas_chemm(
        side, uplo, m, n,
        alpha, (magmaFloatComplex_ptr)dA, ldda,
               (magmaFloatComplex_ptr)dB, lddb,
        beta,  dC, lddc, queue );
    #else
    cublasChemm(
        queue->cublas_handle(),
    ...
    magma_queue_t queue )
{
    ...
    magmablas_ctrmm(
        ...
        alpha, (magmaFloatComplex_ptr)dA, ldda,
               (magmaFloatComplex_ptr)dB, lddb, queue );
    #else
    cublasCtrmm(
        queue->cublas_handle(),
        cublas_side_const( side ),
